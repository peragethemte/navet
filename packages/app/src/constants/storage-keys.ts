export const STORAGE_KEYS = {
  ...
  energyCardOrder: 'navet-energy-card-order',
  energyUsageCardOrder: 'navet-energy-usage-card-order',
  energyHiddenConsumerIds: 'navet-energy-hidden-consumer-ids',
  energyOverviewLayout: 'navet-energy-overview-layout-v1',
  energyKpisHidden: 'navet-energy-kpis-hidden',
  energyKpiPreferences: 'navet-energy-kpi-preferences-v1',
  // Keep the persisted key so existing quickview selections survive the editor replacement.
  securityQuickviewPreferences: 'navet-security-overview-preferences-v1',
